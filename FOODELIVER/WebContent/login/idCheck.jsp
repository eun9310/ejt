...
<form action="<%=request.getContextPath() %>/memberlogincheck.join" method="post" name=f>
	<input type="text" name="id" id="id" class="inputbox"><br>
	<input type="submit" value="중복 확인" style="width:260px;height:40px;margin-top:10px;background:#3EB1B0;color:white;border:0px;cursor:pointer">
</form>
	<%
