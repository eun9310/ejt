...
<form action="<%=request.getContextPath() %>/company_app.mail" method="post">
<table>
	<tr>
		<td >
			<h1>기업용 가입신청서</h1>
	...
	<tr>
		<td><label for="company_name">회사 이름</label></td>
	</tr>
	<tr>
		<td><input type="text" name="company_name" id="company_name" class="inputbox" required="required"/></td>
	</tr>
	<tr>
		<td style="padding-top:20px;"><label for="company_ceo" >CEO</label></td>
	</tr>
	<tr>
		<td><input type="text" name="company_ceo" id="company_ceo" class="inputbox" required="required"/></td>
	</tr>	
	<tr>
